...
function takeinfoEmployee() {
    ...
    isValid &= validation.checkEmpty(Number(luongCB), "salaryTB", "(*)Lương cơ bản không được bỏ trống") && validation.checkNumber(Number(luongCB), "salaryTB", "(*)Vui lòng nhập số !") && validation.checkSalary(Number(luongCB), "salaryTB", "(*)Lương cơ bản phải từ 1 triệu đến 20 triệu", 1000000, 20000000);
