...
function takeinfoEmployee() {
    ...
    isValid &= validation.checkEmpty(luongCB, "salaryTB", "(*)Lương cơ bản không được bỏ trống") && validation.checkSalary(luongCB, "salaryTB", "(*)Lương cơ bản phải từ 1 triệu đến 20 triệu", 1000000, 20000000);
    isValid &= validation.checkEmpty(gioLam, "timeTB", "(*)Giờ làm không được bỏ trống")(gioLam, "timeTB", "(*)Vui lòng nhập số !") && validation.checkSalary(gioLam, "timeTB", "(*)Số giờ làm phải từ 80 đến 200 giờ", 80, 200);
    //check form
...
function fix(account) {
    ...
    var employee = listEmpoyee._fix(account);
