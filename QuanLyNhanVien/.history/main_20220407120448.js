...
function takeinfoEmployee() {
    ...
    isValid &= validation.checkEmpty(gioLam, "timeTB", "(*)Giờ làm không được bỏ trống") && validation.checkNumber(gioLam, "timeTB", "(*)Vui lòng nhập số !") && validation.checkSalary(luongCB, "gioLam", "(*)Số giờ làm phải từ 80 đến 200 giờ", 80, 200);
    //check form
