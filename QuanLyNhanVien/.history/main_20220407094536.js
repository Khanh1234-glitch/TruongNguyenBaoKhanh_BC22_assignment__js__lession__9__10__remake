...
function takeinfoEmployee() {
    ...
    //Validation
    isValid &= validation.checkEmpty(account, "accountTB", "(*)Tài khoản không được bỏ trống") && validation.checklength(account, "accountTB", "(*)Độ dài kí tự từ 4 đến 10");
    ...
    isValid &= validation.checkEmpty(luongCB, "salaryTB", "(*)Lương cơ bản không được bỏ trống");
    isValid &= validation.checkEmpty(chucvu, "spTB", "(*)Chức vụ không được bỏ trống");
    isValid &= validation.checkEmpty(gioLam, "timeTB", "(*)Giờ làm không được bỏ trống");
    //check form
