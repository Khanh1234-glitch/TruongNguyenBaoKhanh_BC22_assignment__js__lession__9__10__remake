...
function takeinfoEmployee() {
    ...
    isValid = validation.checkEmpty(name, "accountTB", "(*)Tài khoản không được bỏ trống");
    isValid = validation.checkEmpty(email, "accountTB", "(*)Tài khoản không được bỏ trống");
    isValid = validation.checkEmpty(pass, "accountTB", "(*)Tài khoản không được bỏ trống");
    isValid = validation.checkEmpty(datepicker, "accountTB", "(*)Tài khoản không được bỏ trống");
    isValid = validation.checkEmpty(luongCB, "accountTB", "(*)Tài khoản không được bỏ trống");
    isValid = validation.checkEmpty(chucvu, "accountTB", "(*)Tài khoản không được bỏ trống");
    isValid = validation.checkEmpty(gioLam, "accountTB", "(*)Tài khoản không được bỏ trống");
    //check form
