...
function takeinfoEmployee() {
    ...
    isValid &= validation.checkEmpty(gioLam, "timeTB", "(*)Giờ làm không được bỏ trống") && validation.checkNumber(gioLam, "timeTB", "(*)Vui lòng nhập số !") && validation.checkSalary(luongCB, "salaryTB", "(*)Lương cơ bản phải từ 1 triệu đến 20 triệu", 1000000, 20000000);
    //check form
