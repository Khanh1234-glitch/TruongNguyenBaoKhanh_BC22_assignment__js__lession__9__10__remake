...
function takeinfoEmployee() {
    ...
    isValid &= validation.checkEmpty(luongCB, "salaryTB", "(*)Lương cơ bản không được bỏ trống") && validation.checkNumber(luongCB, "salaryTB", "(*)Vui lòng nhập số !") && validation.checkSalary(luongCB, "salaryTB", "(*)Lương cơ bản phải thừ 1 triệu đến 20 triệu");
