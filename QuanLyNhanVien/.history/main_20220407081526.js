...
function takeinfoEmployee() {
    ...
    isValid = validation.checkEmpty(datepicker, "dayTB", "(*)Tài khoản không được để trống");
    isValid = validation.checkEmpty(luongCB, "salaryTB", "(*)Tài khoản không được để trống");
