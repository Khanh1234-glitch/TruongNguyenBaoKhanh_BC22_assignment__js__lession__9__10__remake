...
function takeinfoEmployee() {
    ...
    isValid &= validation.checkEmpty(pass, "passTB", "(*)Mật khẩu không được bỏ trống") && validation.checkpassword(pass, "passTB", "(*)Vui lòng nhập mật khẩu có 1 kí tự số, 1 chữ viết hoa và 1 kí tự đặc biệt");
