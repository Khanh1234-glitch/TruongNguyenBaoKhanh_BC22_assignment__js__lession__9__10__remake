...
function takeinfoEmployee() {
    ...
    var result = gioLam;
    var classifica = classification(result);
    Document.getElementById("classification").innerHTML = classifica;
    //flag
    var isValid = true;
    //Validation
    ...
    var employee = new Employee(account, name, email, pass, datepicker, luongCB, chucvu, gioLam, classifica);
    return employee;
};
        ...
        for (var i = 0; i < arr.length; i++) {
            ...
            content += `
                <tr>
                        ...
                        <td id="classification">${employee.classifica}</td>
                        <td>
