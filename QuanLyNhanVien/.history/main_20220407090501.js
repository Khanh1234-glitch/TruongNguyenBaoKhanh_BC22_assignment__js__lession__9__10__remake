...
function takeinfoEmployee() {
    ...
    isValid = validation1.checkEmpty(luongCB, "salaryTB", "(*)Lương cơ bản không được bỏ trống");
    isValid = validation.checkEmpty(chucvu, "spTB", "(*)Chức vụ không được bỏ trống");
    isValid = validation1.checkEmpty(gioLam, "timeTB", "(*)Giờ làm không được bỏ trống");
    //check form
