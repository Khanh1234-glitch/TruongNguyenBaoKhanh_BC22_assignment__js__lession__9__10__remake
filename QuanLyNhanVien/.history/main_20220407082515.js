...
var validation1 = new Validation1();
...
function takeinfoEmployee() {
    ...
    var isValid = true;
    //Validation
    isValid = validation.checkEmpty(account, "accountTB", "(*)Tài khoản không được để trống");
    ...
    isValid = validation1.checkEmpty(luongCB, "salaryTB", "(*)lương cơ bản không được để trống");
    isValid = validation.checkEmpty(chucvu, "spTB", "(*)chức vụ không được để trống");
    isValid = validation1.checkEmpty(gioLam, "timeTB", "(*)Giờ làm không được để trống");
    //check form
