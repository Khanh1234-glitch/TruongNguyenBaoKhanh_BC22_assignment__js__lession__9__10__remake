...
function takeinfoEmployee() {
    ...
    isValid &= validation.checkEmpty(luongCB, "salaryTB", "(*)Lương cơ bản không được bỏ trống") && validation.checkNumber(luongCB, "salaryTB", "(*)Vui lòng nhập số !") && validation.checklength(luongCB, "salaryTB", "(*)Lương phải từ 1 triệu đến 20 triệu", 1.000000, 20000000);
