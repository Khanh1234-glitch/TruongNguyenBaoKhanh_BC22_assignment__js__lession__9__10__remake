...
function takeinfoEmployee() {
    ...
    var isValid = true;
    //Validation MaSV
    isValid &= validation.checkEmpty(account, "divErrorMaSV", "(*) MaSV không được rỗng") && validation.checkleghtletter(id, "divErrorMaSV", "(*)Độ dài kí tự từ 4 đến 10", 4, 10);
    //Validation name
    ...
    //Validation dob
    isValid &= validation.checkEmpty(datepicker, "divErrordateSV", "(*) dobSV không được rỗng");
    //Validation mathscore
    isValid &= validation.checkEmpty(luongCB, "divErrorToanSV", "(*) Không được bỏ trống điểm");
    //Validation diemLy
    isValid &= validation.checkEmpty(chucvu, "divErrorLySV", "(*) Không được bỏ trống điểm");
    //Validation diemHoa
    isValid &= validation.checkEmpty(gioLam, "divErrorHoaSV", "(*) Không được bỏ trống điểm");
